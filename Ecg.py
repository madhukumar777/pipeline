...
class ECG:
	...
	def DimensionalReduciton(self,test_final):
		...
		returns the final dataframe
		"""
		#first load the trained pca from the Deployment folder
		pca_path = os.path.join(os.path.dirname(__file__), 'PCA_ECG (1).pkl')
	...
	def ModelLoad_predict(self,final_df):
		...
		"""
		# Load classifier from the Deployment folder
		model_path = os.path.join(os.path.dirname(__file__), 'Heart_Disease_Prediction_using_ECG (4).pkl')
